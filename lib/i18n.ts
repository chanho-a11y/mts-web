...
const DICT = {
  ko: {
    ...
    addressSearch: "주소 검색",
    addressAlias: "배송지 별칭 (선택)", addressAliasPlaceholder: "예: 집 · 회사 · 강남점",
    editAddress: "수정", editAddressTitle: "배송지 수정", addAddressTitle: "새 배송지",
    addressLimitNote: "배송지는 최대 {max}개까지 저장할 수 있습니다.",
    addressLimitReached: "배송지는 최대 {max}개까지 저장할 수 있습니다. 기존 배송지를 삭제하거나 수정해 주세요.",
    addressSaveFailed: "배송지 저장에 실패했습니다. 잠시 후 다시 시도해 주세요.",
    addressRequiredFields: "받는 분·전화번호·기본 주소는 필수입니다.",
    addressSaved: "배송지가 저장되었습니다.",
    addressDeleteConfirm: "이 배송지를 삭제할까요?",
    // 체크아웃 - 배송지 선택
    savedAddresses: "저장된 배송지",
    chooseSavedAddress: "저장된 배송지에서 선택",
    enterNewAddress: "새 주소 직접 입력",
    saveToAddressBook: "이 주소를 주소록에 저장",
    saveToAddressBookFull: "주소록이 가득 찼습니다(최대 {max}개). 마이페이지에서 정리 후 저장할 수 있습니다.",
    manageAddresses: "배송지 관리",
    // 계정 - 마이페이지
  ...
  en: {
    ...
    addressAlias: "Address label (optional)", addressAliasPlaceholder: "e.g. Home · Office · Gangnam store",
    editAddress: "Edit", editAddressTitle: "Edit address", addAddressTitle: "New address",
    addressLimitNote: "You can save up to {max} addresses.",
    addressLimitReached: "You can save up to {max} addresses. Please delete or edit an existing one.",
    addressSaveFailed: "Could not save the address. Please try again shortly.",
    addressRequiredFields: "Recipient, phone and address are required.",
    ...
    saveToAddressBook: "Save this address to my address book",
    saveToAddressBookFull: "Your address book is full ({max} max). Tidy it up on My Page to save more.",
